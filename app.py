...
GUIDES = [
    ...
    {"id": 3, "title": "Атбаш", "content": "https://ru.wikipedia.org/wiki/Атбаш<br>Популярный шифр для тех, кому наскучил Цезарь :)"},
    {"id": 4, "title": "Шифр Виженера", "content": "https://ru.wikipedia.org/wiki/Шифр_Виженера<br>Помните, что для дешифровки недостаточно сообщения, - нужен еще и ключ!"},
    {"id": 5, "title": "Азбука Морзе", "content": "https://tr.pinterest.com/pin/862580134855149008/"},
    {"id": 6, "title": "Ультрафиолетовый фонарик", "content": "Используйте ультрафиолетовый фонарик, чтобы видеть больше и разгадать загадки преступника! А еще не светите им в глаза, это вредно для них. Если он разрядится, его можно зарядить от вашего powerbankа."},
    {"id": 7, "title": "Книжный шифр", "content": "Используется, только если получатель сообщения знает нужную книгу.<br>Каждое слово загадывается тремя числами: номер страницы книги, номер строки на этой странице, номер слова в этой строке."},
    {"id": 8, "title": "Список полезных ссылок", "content": "ya.ru - для поиска информации<br>ya.ru/maps - карты<br>ya.ru/images - поиск по картинке<br>https://paintz.app - для онлайн-работы с изображениями<br>https://mp3cut.net/ru - для работы с аудио"},
]
